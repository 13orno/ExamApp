namespace SeliseExamApp.DataAccess.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SeliseExamApp.DataAccess.DataContext>
    {
        ...
        protected override void Seed(SeliseExamApp.DataAccess.DataContext context)
        {
